...
class LookbookBlockController extends BlockController {
/*    ^^^^^^^^^^^^^^^
      CHANGE THIS PORTION
...
*/
	...
	protected $btTable = 'btLookbook'; //Must be the same as table name in db.xml.
	                                          //Should correspond to block's directory/class name.
	
	public function getBlockTypeName() {
		return t('Lookbook'); //Appears in "Add Block" list when adding blocks to a page
	}
	
	public function getBlockTypeDescription() {
		return t('Lookbook allows a slideshow to contain huge images because it loads them asynchronously.  This plugin was developed for manoszapotecas.com by gundlach-marketing.com'); //Only appears in dashboard "Add Functionality" page
	}
